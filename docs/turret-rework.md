...
- map 04 is a narrow north-to-south corridor with solid side boundaries and visible walls. map 05 uses the clusters terrain with seed-derived rift locations along the outer north/east/west boundaries. unlock timing is retained.
